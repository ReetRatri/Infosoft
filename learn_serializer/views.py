...
from .models import Book ,Author , Department ,Employeee ,Project ,Employee_Project
from .serializers import Book_serializer ,Author_serializer , Employee_Project_serializer , Project_serializer , Department_serializer 
...
@api_view(['GET' , 'POST'])
@permission_classes([AllowAny])
def get_Employee_Project(request):
    Employee_Project_data = Employee_Project.objects.all()
    serializer = Employee_Project_serializer(Employee_Project_data, many=True)
    if request.method == 'GET':
